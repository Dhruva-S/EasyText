...
export declare function copyFileOrDir(sourceFileOrDir: string, dest: string): Promise<void>;
export declare function downloadFile(fileUrl: string): Promise<DownloadResult>;
...
export declare function getProcessEnvs(val: string): any;
